    ...
    <div className="h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center">
      ...
      <div className="flex flex-col space-y-10">
        <div className="flex flex-col mt-10">
          ...
          <span className="text-2xl sm:text-4xl font-semibold text-center underline decoration-[#00cec9]/50">
            Hablemos.
          </span>
        </div>
        <div className="space-y-3 md:space-y-10">
          <div className="flex items-center space-x-5 justify-center">
            ...
            <p className="text-lg md:text-2xl">+54 342 4790459</p>
          </div>
          <div className="flex items-center space-x-5 justify-center">
            <MapPinIcon className="text-[#00cec9] h-7 w-7 animate-pulse" />
            <p className="text-lg md:text-2xl">Santa Fe, Argentina - CP 3000</p>
          </div>
          <div className="flex items-center space-x-5 justify-center">
            <EnvelopeIcon className="text-[#00cec9] h-7 w-7 animate-pulse" />
            <p className="text-lg md:text-2xl">nicolasregenhardt@hotmail.com</p>
          </div>
        </div>
