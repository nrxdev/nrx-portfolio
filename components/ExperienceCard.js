...
const ExperienceCard = () => {
  return (
    <article className="flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[500px] md:w-[600px] xl:w-[900px] snap-center bg-[#444f52]/90 p-10 opacity-40 hover:opacity-100 cursor-pointer transition-opacity duration-200 overflow-hidden">
      <motion.img
        initial={{
          y: -100,
          opacity: 0,
      ...
      <div className="px-0 md:px-10">
        <h4 className="text-3xl font-light">Tech Lead</h4>
        <p className="font-bold text-xl mt-1">Excelcom S.A.</p>
